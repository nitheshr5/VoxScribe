    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex">
        ...
        >
          ...
          >
            <p className="text-sm text-indigo-600 font-semibold">
              ✨ Get 40 hours of transcription credits for just $1
            </p>
          </motion.div>
        </motion.div>
      </motion.div>
      ...
      >
        ...
        >
          ...
          <motion.form onSubmit={handleEmailLogin} variants={staggerContainer}>
          ...
          <motion.div className="text-center space-y-3" variants={fadeInUp}>
            <p className="text-gray-600">
              ...
              <Link href="/register" className="text-indigo-600 hover:text-indigo-700 font-semibold hover:underline transition-colors duration-300">
                Sign Up
              </Link>
            </p>
            <Link 
              href="/forgot-password" 
              className="block text-indigo-600 hover:text-indigo-700 font-medium hover:underline transition-colors duration-300"
            >
              Forgot Password?
            </Link>
          </motion.div>
